...
public class FieldAccessTest {
  ...
  private final FieldAccess targetPojo;

  public FieldAccessTest(final int type, final String stringToCompile,
  final FieldAccess targetPojo) {
    this.type = type;
  ...
  @Test
  public void test/*TODO test method name*/() {
  ...
  private AstNode contextDispatcher(int classifier, JavaParser parser) {
    ...
    switch(classifier) {
      case DEFAULT :
        return new AstBuilder().visitFieldAccess(parser.fieldAccess());
      case LF_PRIMARY :
        return new AstBuilder().visitFieldAccess_lf_primary(parser.fieldAccess_lf_primary());
      case LFNO_PRIMARY :
        return new AstBuilder().visitFieldAccess_lfno_primary(parser.fieldAccess_lfno_primary());
      default :
